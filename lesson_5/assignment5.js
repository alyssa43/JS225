// 1. What are the two disadvantages of working with factory funcitons?

// ANSWER: One disadvantage is that every object created from a factory function gets copies of the methods it contains. This can use up a lot of memory when creating high volumes of objects. Another disadvantage would be that it doesn't create a link to a "type" and may be hard to determine which function created that object.
...
// 2. The default value for the phone service is `3000`, and the internet service is `5500` (in cents)
...
// 5. Update your `createInvoice` funciton to make it possible to add payment(s) to invoices. Use the code below as a guideline:
